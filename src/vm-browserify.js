// Import the existing vm-browserify functionality
...
const Script = function NodeScript (code) {
...
const createScript = function (code) {
    return Script(code);
};

const createContext = Script.createContext = function (context) {
